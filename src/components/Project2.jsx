  ...
  return (
    ...
    <div className=" ">
        <div className={`h-full min-h-[450px] shadow-sm px-[40px] border-2 rounded-lg mt-[12px] w-full max-w-[330px] flex flex-col items-start justify-between py-[30px] ${isLight ? "border-gray-300":"border-gray-700"}`}>
            ...
            <h1 className='font-medium my-[8px] '>TradeTree</h1>
            
            <p className={`text-[10px] ${isLight ? "text-gray-700": "text-gray-300"}`}>
                This website was built to for people who want to trade their old material and buy as well
            </p>
            ...
            <div className="flex flex-wrap gap-[20px]">
                ...
                <div className={`transition-transform duration-300 ease-in-out hover:scale-105 hover:-translate-y-2 cursor-pointer rounded-md px-[18px] py-[5px] text-[14px] flex flex-row justify-center items-center space-x-[10px] border border-gray-600 hover:text-red-500 ${isLight ? "bg-black text-white": "bg-white text-black"}`}>
                    <button className='cursor-pointer font-medium' onClick={() => window.open("https://youtu.be/u5Y5O0CXd_8", "_blank")}>
                    Youtube
                    </button>
                    <Youtube size = "16" />
                </div> 
                <div className={`transition-transform duration-300 ease-in-out hover:scale-105 hover:-translate-y-2 cursor-pointer rounded-md px-[18px] py-[5px] text-[14px] flex flex-row justify-center items-center space-x-[10px] border border-gray-600 hover:text-green-500 ${isLight ? "bg-black text-white": "bg-white text-black"}`}>
                    <button className='cursor-pointer font-medium' onClick={() => window.open("https://tradetree.netlify.app/", "_blank")}>
                    Website
                    </button>
                    <Chromium size = "16" />
                </div>              
